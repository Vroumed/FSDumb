...
namespace Vroumed.FSDumb.lib
{
    ...
    public class Pca9685 : IDisposable
    {
        ...
        public struct OnOffModel
        {
            public OnOffModel(ushort on, ushort off)
            {
                On = on;
                Off = off;
            }
        ...
        private static OnOffModel DutyCycleToOnOff(double dutyCycle)
        {
        ...
        public void SetDutyCycleAllChannels(double dutyCycle)
        {
            ...
            var val = DutyCycleToOnOff(dutyCycle);
            SetOnOffTimeAllChannels(val.On, val.Off);
        }
        ...
        public Pca9685PwmChannel CreatePwmChannel(int channel)
        {
            CheckChannel(channel);
        ...
        internal void SetDutyCycleInternal(int channel, double dutyCycle)
        {
            ...
            var onOff = DutyCycleToOnOff(dutyCycle);
            SetOnOffTime(channel, onOff.On, onOff.Off);
        }
